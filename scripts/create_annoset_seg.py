...
if __name__ == "__main__":
  ...
  if not os.path.exists(list_file):
    print("list file path: {}".format(list_file))
  ...
  with open(list_file, "r") as lf:
    for line in lf.readlines():
      img_file, anno, img_label_file = line.strip("\n").split(" ")
      if not os.path.exists(root_dir + img_file):
        print("image file: {} does not exist".format(root_dir + img_file))
      if not os.path.exists(root_dir + img_label_file):
        print("image label file: {} does not exist".format(root_dir + img_label_file))
