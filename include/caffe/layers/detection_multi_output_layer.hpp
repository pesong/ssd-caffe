...
class DetectionMultiOutputLayer : public Layer<Dtype> {
 public:
  explicit DetectionMultiOutputLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "DetectionMultiOutput"; }
